...
base.file = paste0('TAIR10_chr', query.chr ,'.fas', collapse = '')
query.file = 'A1.polished_contigs_scaffolded_softmasked_TAIR10.v1.1.fasta'
pref.blsat.res = paste0('A1', '_', query.chr, '_parts_', collapse = '')

query.file = '9728.polished_contigs_scaffolded_softmasked_TAIR10.v1.1.fasta'
pref.blsat.res = paste0('9728', '_', query.chr, '_parts_', collapse = '')
